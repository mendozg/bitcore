...
```sh
git clone git@github.com:mendozg/bitcore.git
git checkout master
npm install
```
...
- [Bitcore Channel](https://github.com/mendozg/bitcore-channel) - Micropayment channels for rapidly adjusting bitcoin transactions
- [Bitcore ECIES](https://github.com/mendozg/bitcore-ecies) - Uses ECIES symmetric key negotiation from public keys to encrypt arbitrarily long data streams
...
- [Bitcore Message](https://github.com/mendozg/bitcore-message) - Bitcoin message verification and signing
